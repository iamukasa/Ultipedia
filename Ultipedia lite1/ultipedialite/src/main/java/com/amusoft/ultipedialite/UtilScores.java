...
import com.shephertz.widget.app42.leaderboard.LeaderBoardActivity;
...
public class UtilScores extends Quiz  {
	...
	private ArrayList<App42LeaderBoardType> leaderBoardList;
	 
	private App42LeaderBoardType selectedLeaderBoard = App42LeaderBoardType.DateRange;
 ...
 private void uploadScoresleaderboard() {
	...
	/**
		...
		leaderBoardList = new ArrayList<App42LeaderBoardType>();
		leaderBoardList.add(App42LeaderBoardType.DateRange);
		leaderBoardList.add(App42LeaderBoardType.Social);
		leaderBoardList.add(App42LeaderBoardType.UserStanding);
		ArrayAdapter<App42LeaderBoardType> dataAdapter = new ArrayAdapter<App42LeaderBoardType>(
				this, android.R.layout.simple_spinner_item, leaderBoardList);
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
			long arg3) {
		// TODO Auto-generated method stub
		selectedLeaderBoard = leaderBoardList.get(arg2);
	...
	public void onLeaderBoardClicked(View view) {
		...
		String q=mGameSettings.getString(GAME_PREFERENCES_USERNAME, null);
			...
			LeaderBoardProperties.setGameName(gameName);
		LeaderBoardProperties.setUserName(q);
		LeaderBoardProperties.setMaxEntries(20);
		LeaderBoardProperties.setLeaderBoardType(selectedLeaderBoard);
