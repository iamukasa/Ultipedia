	 ...
	 protected void onStart(){
		 ...
		 setQuestionView();
		 	...
		 	protected void onStop(){
		 		...
		 		timer.cancel();
		 		if(mGameSettings.contains(GAME_PREFERENCES_USERNAME)
						& mGameSettings.contains(GAME_PREFERENCES_SCORE_ENG)){
					
				
				String gameName = "Ultipedia eng";  
				String q=mGameSettings.getString(GAME_PREFERENCES_USERNAME, null);
				 ...
				 BigDecimal english= new BigDecimal(sEng);
				 ScoreBoardService scoreBoardEnglish=App42API.buildScoreBoardService();
				 scoreBoardEnglish.saveUserScore(gameName,userName,english,new App42CallBack() {  
