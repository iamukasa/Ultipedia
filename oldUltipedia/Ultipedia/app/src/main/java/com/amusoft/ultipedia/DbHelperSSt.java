...
private void addQuestions()
{
	...
	this.addQuestion(q5);
	Question q6=new Question("The following are statements about a community in Eastern Africa During the precolonial period(i)The community was ruled by hereditary kings(ii)The community tradeded with the coast traders(iii)The community practise crop growing",
			"A:The Dinka",
			"B:The Baganda",
			"C:the Chagga",
			"D:The Somali",
