...
// tasks table name
private static final String TABLE_QUEST_SCI = "quest";
...
dbase=db;
String sql3 = "CREATE TABLE IF NOT EXISTS " + TABLE_QUEST_SCI + " ( "
...
private void addQuestions()
{
	...
	Question q2=new Question("Which of the following occurs when rays of light pass from air into water",
			...
			"C:Refraction");
	this.addQuestion(q2);
	Question q3=new Question("Which one of tjhe following factors Does Not affect how high or low sound produced by a stringed instrument it?",
