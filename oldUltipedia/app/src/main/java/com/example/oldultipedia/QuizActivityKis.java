		 ...
		 case GET_WRONG:
			 LayoutInflater inflater3 =
				...
				if(mGameSettings.contains(GAME_CURRENT_ANS_KIS)){
					 String Final=mGameSettings.getString(GAME_CURRENT_ANS_KIS , null);
					wrn.setText(Final);
				}
		AlertDialog.Builder builder3 = new AlertDialog.Builder(this);
			builder3.setView(layoutswrong);
			builder3.setTitle("Jawabu lako si sahihi!!!!!");
				 ...
				 Log.d("yourans", currentQ.getANSWER()+" "+answer.getText());
				  if(currentQ.getANSWER().contentEquals(answer.getText()))
				 	 ...
				 	 String d=String.valueOf(scoreKis);
				 	  ...
				 	  Toast.makeText(getApplicationContext(),"Swadakta",Toast.LENGTH_SHORT).show();
					 }
				 	 else{
